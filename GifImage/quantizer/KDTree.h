...
public:
  ...
  void *createKDTree(Node *node, std::vector<ARGB> &quantize, int32_t start,
                     int32_t end, uint8_t split);

  int searchNoBacktracking(Node *node, uint8_t r, uint8_t g, uint8_t b,
                           int32_t dis);
